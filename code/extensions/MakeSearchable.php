...
class SearchEngineMakeSearchable extends DataExtension {
	...
	public function SearchEngineFieldsForIndexing(){
		...
		if(is_array($levelFields) && count($levelFields)) {
			...
			$levelOneFieldArray = Config::inst()->get("SearchEngineMakeSearchable", "default_level_one_fields");
			$excludedFieldArray = Config::inst()->get("SearchEngineMakeSearchable", "default_excluded_db_fields");
